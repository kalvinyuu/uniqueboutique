import { getOrders, getAddresses, getSpecItem, getOrderItems } from "@/app/utils";
import { Orders, OrderItems, Addresses, SpecificItem } from "@/app/types";
import { orderItems, specificItem } from "../../../drizzle/schema";
import UpdateOrderStat from "@/app/dashboard/updateOrderStatus"

export default async function OrderViewer() {
